...
from config import send_sms, qiniu, send_email
...
class Config:
    ...
    # 商品缩略图上传路径
    UPLOADS_THUMBNAIL_IMAGE = 'uploads/project/thumbnail/'
    UPLOADS_THUMBNAIL_IMAGE_DIR = os.path.join(STATIC_DIR, UPLOADS_THUMBNAIL_IMAGE)
    # 商品图上传路径
...
class DevelopmentConfig(Config):
    ...
    # 发送邮件
    MAIL_DEFAULT_SENDER = send_email.SendEmail.MAIL_USERNAME
    MAIL_SERVER = send_email.SendEmail.MAIL_SERVER
    MAIL_PORT = send_email.SendEmail.MAIL_PORT
    MAIL_USE_SSL = send_email.SendEmail.MAIL_USE_SSL
    MAIL_USERNAME = send_email.SendEmail.MAIL_USERNAME
    MAIL_PASSWORD = send_email.SendEmail.MAIL_PASSWORD
